...
namespace MyApp
{
    internal class Program
    {
        ...
        static NodePath getFastestPath(Node startNode, Node endNode)
        {
        ...
        static void Main(string[] args)
        {
            ...
            NodePath path = getFastestPath(nodes[0], nodes[13]);
            sw.Stop();
            Node[] pathArray = getFastestPath(nodes[0], nodes[13]).pathToNode.ToArray();
